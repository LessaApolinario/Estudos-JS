...
class Tela {
  ...
  static iniciarContador() {
    ...
    const textoPadrao = `Começando ${identificadorNoTexto} segundos...`
    ...
    // essa função vai substituir o $$contador pelo `conatrAte`
    // diminuindo o valor
    // retornam,os o idDoIntervalo para parar ele mais tarde
